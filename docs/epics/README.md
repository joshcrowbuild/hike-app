...
| [040](epic-040-two-phase-render.md) | Two-phase render (graph-only ranked cards <1.5s · `POST /plan/conditions` patch · six-state pending silence) | DEFINED | A | Epic 039 · 018 S4 |
