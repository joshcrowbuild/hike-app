...
| [043](epic-043-managed-auth.md) | Managed auth — Supabase sign-in replaces the shared dev-secret (JWKS → `viewer_id`); anonymous browsing stays un-gated | REVIEW | C | Epic 014 · 011 · auth brief (§47) |
