...
| [glm-redteam-honesty-gates-2026-07.md](glm-redteam-honesty-gates-2026-07.md) | `ACTIVE` (foreign-model adversarial review) | GLM red-team of the source-or-silence invariant: 3 findings (F1 HIGH: NPS closure alerts not routed to CardWarning, F2 MEDIUM: stale_degraded untestable in replay, F3 LOW: AQI warn boundary coverage) + 3 eval scenarios (2 gate-skipped failing, 1 passing). **Read when** auditing honesty-gate coverage or scoping closure-warning routing. |
