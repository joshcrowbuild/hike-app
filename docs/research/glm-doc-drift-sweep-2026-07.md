...
| **Epic Index Completeness:** (Implicit claim that `docs/epics/README.md` contains all epics) | `docs/epics/README.md` | `docs/epics/epic-026-tag-classification.md` exists and is DONE, but is missing from the table in `docs/epics/README.md`. | **WRONG** | Insert row for 026: `\| [026](epic-026-tag-classification.md) \| Classify OSM tags... \| DONE ✅ \| 1 \| Epic 023 \|` |
